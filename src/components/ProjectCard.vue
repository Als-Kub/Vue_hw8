<template>
  <div class="card">
    <div @click="toggleStar" class="card__img-box">
      <img :src="card.img" alt="card img" class="card" />
      <svg
        class="card__svg"
        :class="starStyle"
    ...
    <div class="card__content">
      <div class="card__desc">
        ...
        <p class="card__text">Decor / Artchitecture</p>
      </div>
...
export default {
  ...
  methods: {
    toggleStar() {
      if (this.starStyle === "") {
        this.starStyle = "card__svg_active";
      } else {
        this.starStyle = "";
      }
    },
